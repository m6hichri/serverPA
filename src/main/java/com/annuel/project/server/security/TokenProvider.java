...
public class TokenProvider {
    ...
    private final long tokenValidityInMilliseconds = Duration.ofMinutes(40).getSeconds() * 1000;
    ...
    public String createToken(Authentication authentication) {
        ...
        if(authentication.getPrincipal() instanceof UserToken){
            UserToken userToken = (UserToken) authentication.getPrincipal();
            try {
                jwt.claim("userDetail", userToken.getUserDetail());
            } catch (Exception e){
                jwt.claim("userDetail", "{}");
            }
        }
